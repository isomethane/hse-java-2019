...
public class SmartListTest {
    ...
    @Test
    public void testAddToSmallArray() {
        List<Object> list = newList();
        list.add(1);
        list.add(3);
        list.add(0, 0);
    ...
    @Test
    public void testRemoveFromSmallArray() {
        List<Object> list = newList();
        list.add(0);
        list.add(10);
        list.add(1);
    ...
    public void testOutOfBounds() {
        ...
        list.add(10);
        list.add(2);
        assertThrows(IndexOutOfBoundsException.class, () -> list.add(6, 3));
    ...
    private static Class<?> getListClass() throws ClassNotFoundException {
        return Class.forName("ru.hse.mnmalysheva.SmartList");
    }
}